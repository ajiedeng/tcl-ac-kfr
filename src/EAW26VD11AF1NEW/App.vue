...
import TimeGroup from './components/Times.vue'
    ...
    opts (key, value) {
      ...
      switch (Number(key)) {
        ...
        case 1001:
          if (value === '0') {
            // 自动模式
            this.$gomesmart.opt([15,1001,33,26,3,1004], [0,0,0,0,0,0]);
          } else if (value === '1') {
            // 制冷
            this.$gomesmart.opt([15,1001,33,26,3,1004], [0,1,0,0,0,0])
          } else if (value === '2') {
            // 除湿
            this.$gomesmart.opt([15,1001,33,26,1002,26,3,1004], [0,2,0,0,1,0,0,0])
          } else if (value === '3') {
            // 制热
            this.$gomesmart.opt([15,1001,33,26,3,1004], [0,3,0,0,1,0])
          } else if (value === '4') {
            // 送风
            this.$gomesmart.opt([15,1001,26,33,3,1004], [0,4,0,0,0,0])
          }
          break
